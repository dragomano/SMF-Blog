...
- integrate_who_allowed (`&self::$allowedActions`)
- --who_allowed (`&self::$allowedActions`)-- — Используйте `integrate_who_allowed`
- integrate_whos_online (`$actions`)
- integrate_whos_online_after (`&$url_list, &$data`)
- --whos_online_after (`&$urls, &$data`)-- — Используйте `integrate_whos_online_after`
